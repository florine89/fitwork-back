...
VALUES ('Abdos au bureau','Soulève tes jambes en posant tes mains sur ta chaise ou sur ton bureau.','00:01:00','abdoaubureau.png','Activité',1,1),
    ...
    ('Étirement latéral','D''un côté puis de l''autre, étires-toi latéralement tout en respirant profondément. Maintiens ça pendant 1min30.','00:01:30','etirementcote,png','Activité',1,1),
    ('Bras engourdis','Appuies-toi sur ta table de bureau et fais des mouvements de va et vient, comme des pompes au sol, pendant 45 secondes. Répètes le 2 fois si tu en ressens le besoin.','00:00:45','pompes.png','Activité',1,1),
